...
@section('content')
    <div class="sec-1-contact overflow-hidden pt-120">
        <div class="container">
            <div class="row align-items-end">
                <div class="col-xxl-6 col-lg-7">
                    <div class="at-about-title-wrap mb-30">
                        ...
                        <h2 class="at-section-title reveal-text mb-lg-0 mb-4">
                ...
                <div class="col-xxl-4 col-lg-5 col-md-8 ms-xxl-auto position-relative">
                    ...
                    <form class="sec-4-about-form" action="#" method="post">
                        ...
                        <div class="sec-4-about-form__actions">
                            <button type="submit" class="sec-4-about-form__btn at-btn">
                                <span>
                                    <span class="text-1 text-capitalize">Send Message</span>
                                    <span class="text-2 text-capitalize">Send Message</span>
                                </span>
                                <i>
                                    <svg width="11" height="11" viewBox="0 0 11 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="sec-4-about-form__disclaimer">
                            By submitting, you agree to our <a href="#" class="sec-4-about-form__link">Terms</a> and
                            <a href="#" class="sec-4-about-form__link">Privacy Policy</a>.
                        </p>
                    </form>
                </div>
                <div class="col-xxl-4 col-lg-5 ms-auto pb-40">
                    <h5 class="h6 fw-600 mb-3">Follow Us</h5>
                    <div class="alt-footer-social-item white-mode w-50">
                        <ul>
                            <li>
                                <a href="#">
