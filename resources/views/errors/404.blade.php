        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-10 offset-xl-1 ps-xl-0 text-center">
                    <img src="{{ asset('assets/img/404.jpg') }}" width="503" height="503" alt="404 Image"
                        class="mx-auto d-block mb-40">
                    <h3 class="fs-24 fw-extrabold text-title mt-5 mb-40">Sorry! The page you are looking for could not
                        be found.
                    </h3>
                    <a href="{{ url('/') }}"
                        class="btn style-one d-inline-flex flex-wrap align-items-center p-0"><span
                            class="btn-text d-inline-block fw-semibold position-relative transition">Back To
                            Home</span><span
